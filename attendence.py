...
class Attendence:
    def __init__(self,root):
        ...
        self.var_atten_attendance =StringVar()
         ...
         #background image
        imgbg=Image.open(r"C:\Users\Admin\Downloads\downloaddfsdfdz.jpeg  ")
        ...
        import_btn=Button(btn_frame,text="Import CSV",command=self.import_csv,width=16,height=2 ,font=("chalkduster",12,"bold"),bg="skyblue",fg="green",cursor="hand2")
        import_btn.grid(row=0,column=0)

        export_btn=Button(btn_frame,text="Export CSV",command=self.export_csv,width=16,height=2 ,font=("chalkduster",12,"bold"),bg="skyblue",fg="green",cursor="hand2")
        export_btn.grid(row=0,column=1)

        update_btn=Button(btn_frame,text="Update",width=16,height=2 ,font=("chalkduster",12,"bold"),bg="skyblue",fg="green",cursor="hand2")
        update_btn.grid(row=0,column=2)

        Reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=16,height=2 ,font=("chalkduster",12,"bold"),bg="skyblue",fg="green",cursor="hand2")
