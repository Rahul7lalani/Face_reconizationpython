...
class Developer:
    def __init__(self,root):
        ...
        #background image
        imgbg=Image.open(r"C:\Users\Admin\Downloads\image1-4.jpg")
        ...
        imgstudent=Image.open(r"C:\Users\Admin\Downloads\image1-4.jpg")
        ...
        a_lbl.place(x=10,y=220,width=250,height=50)
